...
<br ><br>
<font color="red">*</font>Roll Number&nbsp;:&nbsp;<input  rel="tooltip" title="Only pure numerical Roll numbers are accepted." type="number" name="Roll No." style="color: #FFFFFF; font-family: Verdana; font-weight: bold; font-size: 12px; background-color: #72A4D2;" value="<% out.print(DB.DBlayer.getScalar("select rollno from student where studentid='"+session.getAttribute("id")+"';")); %>" readonly><br><br>
