...
<%
      ...
      String from = "rdshotspot@gmail.com";//change accordingly
      final String username = "rdshotspot";//change accordingly
      final String password = "dontforget";//change accordingly
      String s="";
